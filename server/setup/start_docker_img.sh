...
if [ ${machine} = "Mac" ]; then
    ...
    echo "to attaching to a ROS network on LAN (necessary for the ros_handler to "
    echo "subscribe to topics and get imaging data). Unfortunately the best solution at the moment"
