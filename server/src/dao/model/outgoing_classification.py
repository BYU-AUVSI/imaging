class outgoing_classification(object):
    """
    Model class for outgoing classification table entries. This model describes
    and stores the common column elements between the 'outgoing_manual' and 
    'outgoing_autonomous' tables. At the time of writing, they are identical. In
    the future if it is decided they need to diverge, describe these diverging
    values in the corresponding child classes (outgoing_manual or outgoing_autonomous)
    """
    ...
    def allProps(self):
        return ['class_id', 'crop_id', 'type', 'target', 'latitude', 'longitude', 'orientation', 'shape', 'background_color', 'alphanumeric', 'alphanumeric_color', 'description', 'submitted']
