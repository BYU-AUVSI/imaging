...
class TestManualCroppedPost(unittest.TestCase):
    def test(self):
        resetManualDb()
...
class TestManualCroppedGetNext(unittest.TestCase):
    def test(self):
        resetManualDb()
...
class TestManualCroppedGetId(unittest.TestCase):
    def test(self):
        resetManualDb()
...
class TestManualCroppedGetIdInfo(unittest.TestCase):
    def test(self):
        resetManualDb()
...
class TestManualCroppedGetAll(unittest.TestCase):
    def test(self):
        resetManualDb()
