...
WIDTH_  = DIM_
FONT_PTS_ = [80, 100, 120] # font sizes to use in generation
...
ttlIterations = len(ALPHABET_) * len(FONTS_) * ROTATE_STEPS_ * len(FONT_PTS_) * len(BLURS_)
