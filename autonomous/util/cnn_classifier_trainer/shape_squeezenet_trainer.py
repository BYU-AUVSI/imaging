...
num_classes = 14 # 13 shapes + 1 no target class
...
def train_model(model, dataloaders, criterion, optimizer, num_epochs=25):
    try:
        ...
        # if someone hits ctrl+c get the best model and save it before exiting
...
torch.save(model_ft, 'shape-squeezenet-' + dt + '.pt')
